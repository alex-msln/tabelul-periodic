...
function setColor(color) {
  ...
  let darkerColorRGB = hexToRgb(darkerColor50);
  ...
  root.style.setProperty("--darker-color-rgb", darkerColorRGB);
...
function setScenarios() {
  ...
  if (defaultName === "off") scenario = defaultAtmNo === "off" ? "scenario1" : "scenario2";
  else scenario = defaultAtmNo === "off" ? "scenario3" : "scenario4";

  for (var i = 0; i < singleNum.length; i++) {
    if (scenario === "scenario1") singleNum[i].style.fontSize = "0.84em";
    else if (scenario === "scenario4") singleNum[i].style.fontSize = "0.78em";
    else singleNum[i].style.fontSize = "0.8em";
  }
  ...
  for (var i = 0; i < singleWt.length; i++) {
    if (defaultAtmNo === "off") singleWt[i].style.display = "none";
    else {
      ...
      if (defaultPunc === "comma") singleWt[i].textContent = singleWt[i].textContent.replace(/\./g, ",");
    }
  }

  for (var i = 0; i < singleNm.length; i++) {
    if (defaultName === "off") singleNm[i].style.display = "none";
    else {
...
function setLanguage() {
  ...
  if (currentLang === "en") {
    if (langValue === "en") location.href = currentPage.replace(currentLang + ".", "");
    // location.href= currentPage.replace(currentLang, langValue)
    else location.href = currentPage.replace("periodic", langValue + ".periodic");
  } else {
    if (langValue === "en") location.href = currentPage.replace(currentLang + ".", "");
    else location.href = currentPage.replace(currentLang, langValue);
  }
}
